...
I moved to the US for my **Master's at Northeastern University**, where I went deep into machine learning, big data, and cloud systems. This is where I built most of the projects you'll see below: production-style ETL pipelines with Airflow and Snowflake, RAG systems for unstructured data processing, incremental data pipelines with CI/CD. Beyond coursework, I also worked as a **Research Assistant** with **Pacific Northwest National Laboratory (PNNL)**, building ML pipelines on Databricks to process 20+ GB of proteomic data across 50+ bacterial species.
